...
Briefly, this approach uses centered log-ratio tranformation to account for the compositionality of microbiome data, 
and then uses singular value decomposition and UMAP to reduce its dimensionality. The resulting components serve as
mediators in the mediation analysis. We use a mediation analysis technique that utilizes inverse odds ratio 
weighting to estimate the indirect effect of multiple mediators. We finally employ a permutation test to test the 
significance of the observed indirect effect. 
